...
import { CheckCircle, Sparkles, Shield, Clock, Star } from 'lucide-react';
          ...
          <div className="flex flex-col md:flex-row md:items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <p className="text-xl text-blue-100 mb-8">
                ...
                From regular maintenance to specialized cleaning solutions, we deliver exceptional results.
              </p>
            ...
            <div className="md:w-1/2 md:pl-10">
              <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20">
                <div className="flex items-center mb-4">
                  ...
                  <Star className="text-yellow-400 mr-1" size={20} fill="currentColor" />
                  <Star className="text-yellow-400 mr-1" size={20} fill="currentColor" />
                  <span className="ml-2 text-white font-medium">5.0 (250+ Reviews)</span>
                </div>
                <h3 className="text-xl font-semibold mb-3">Why Choose Our Cleaning Services?</h3>
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="text-green-400 mr-2 flex-shrink-0 mt-1" size={18} />
                    <span>Comprehensive cleaning checklists for consistency</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="text-green-400 mr-2 flex-shrink-0 mt-1" size={18} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We offer comprehensive cleaning solutions tailored to your specific needs, ensuring a spotless and healthy environment.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-sm text-center">
              ...
              <p className="text-gray-600">We evaluate your space and discuss your specific cleaning needs.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">We create a customized cleaning plan tailored to your requirements.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">Our professional team performs thorough cleaning using quality products.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">We conduct a final walkthrough to ensure everything meets our standards.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-3">How long does a typical deep cleaning take?</h3>
              <p className="text-gray-600">The duration depends on the size of your space and the level of cleaning required. A standard home deep cleaning typically takes 4-8 hours with our professional team.</p>
            </div>
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Do I need to provide cleaning supplies?</h3>
              <p className="text-gray-600">No, we bring all necessary cleaning supplies and equipment. We use eco-friendly products that are effective yet safe for your family and pets.</p>
            </div>
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-3">How often should I schedule deep cleaning?</h3>
              <p className="text-gray-600">For most homes, we recommend deep cleaning every 3-6 months, in addition to regular maintenance cleaning. High-traffic commercial spaces may require more frequent deep cleaning.</p>
            </div>
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Is your cleaning service insured?</h3>
              <p className="text-gray-600">Yes, our cleaning service is fully insured. This provides protection for both our team and your property during the cleaning process.</p>
            </div>
          </div>
