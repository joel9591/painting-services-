...
export const metadata = {
  ...
  description: 'Read what our clients say about our professional home services including painting, plumbing, electrical work, and more.',
  keywords: 'home services testimonials, client reviews, customer feedback, service ratings, home improvement reviews',
  openGraph: {
    title: 'Client Testimonials - Professional Home Services',
    description: 'Discover what our satisfied clients have to say about our quality workmanship and professional service.',
  },
};
                ...
                <div className="p-8">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-blue-600">{testimonial.service} • {testimonial.location}</p>
                    </div>
                  </div>
