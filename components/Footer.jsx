...
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1 pt-6 sm:pt-10">
...
//           <div className="grid grid-cols-2 gap-12 sm:gap-16 sm-w-full w-full ">
//             {/* Services */}
//             <div>
...
//           {/* Contact Info */}
//           <div className="lg:ml-40 min-w-full ">
