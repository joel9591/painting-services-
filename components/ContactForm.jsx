...
//           {/* Contact Information */}
//           <div>
//             <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-3 sm:mb-6">
//               Get In Touch
//             </h3>
...
//                 >
//                   <div className="text-blue-600 bg-blue-100 p-2 sm:p-3 rounded-lg flex-shrink-0 flex items-center justify-center">
//                     {item.icon}
//                   </div>
//                   <div>
...
//           {/* Contact Form */}
//           <div>
//             <div className="bg-white rounded-xl shadow-xl sm:shadow-xl p-1 sm:p-2 sm:py-4 px-2 sm:px-4">
              ...
              <form ref={form} onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={formData.name}
                    onChange={handleChange}
                    className="w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring focus:ring-blue-200"
                    placeholder="Enter your full name"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {services.map((service) => (
                      <label
                        key={service}
                        className="flex items-center space-x-2 cursor-pointer border rounded-lg px-3 py-2 hover:bg-gray-50 transition text-xs sm:text-sm"
                      >
                        <input
                          type="checkbox"
                          checked={formData.services.includes(service)}
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className={`w-full py-3 px-4 rounded-lg font-semibold text-white transition-all duration-300 flex items-center justify-center space-x-2 text-sm sm:text-base ${
                    isSubmitting
                      ? "bg-gray-400 cursor-not-allowed"
